...
namespace TransparentForm
{
    public partial class GraphicsPathForm : Form
    {
        ...
        {
            InitializeComponent();
            this.DoubleClick += new EventHandler(GraphicsPathForm_DoubleClick);
        }
        ...
        private void Frm_MouseMove(object sender, MouseEventArgs e)
        {
            if (isMouseDown)
            {
                ...
                Location = mousePos;
                gf1.SetDesktopLocation(this.Location.X + 150, this.Location.Y + 150);
                gf2.SetDesktopLocation(this.Location.X - 250, this.Location.Y - 150);
        ...
        #endregion
        #region 双击窗口浮现和消失
        void GraphicsPathForm_DoubleClick(object sender, EventArgs e)
        {
            if (gf1.Visible == true)
            {
                gf1.Visible = false;
