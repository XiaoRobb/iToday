...
namespace TransparentForm
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_MouseEnter(object sender, EventArgs e)
        {
            ...
            {
                case 1:
                    kuang.SetDesktopLocation(Location.X + 25, Location.Y + 30);
                    break;
                case 2:
                    kuang.SetDesktopLocation(Location.X + 25, Location.Y - 215);
                    break;
                case 3:
                    kuang.SetDesktopLocation(Location.X - 225, Location.Y + 30);
                    break;
                case 4:
                    kuang.SetDesktopLocation(Location.X - 225, Location.Y - 215);
                    break;
            }
            kuang.Visible = true;
        }
