...
namespace TransparentForm
{
    public partial class UpdateLayeredWindowForm : Form
    {
        ...
        bool yuanHandle = false;//小窗口创建
        Form1 yuan1 = new Form1(1);
        Form1 yuan2 = new Form1(2);
        Form1 yuan3 = new Form1(3);
        Form1 yuan4 = new Form1(4);
        ...
        private void Frm_MouseMove(object sender, MouseEventArgs e)
        {
            if (isMouseDown)
            {
                ...
                Location = mousePos;
                yuan1.Location = new Point(Location.X + 150 , Location.Y +100);
                yuan2.Location = new Point(Location.X + 150, Location.Y - 75);
                yuan3.Location = new Point(Location.X - 100, Location.Y + 100);
                yuan4.Location = new Point(Location.X - 100 , Location.Y - 75);
            }
        }
        ...
        void Form2_DoubleClick(object sender, EventArgs e)
        {
            //this.Dispose();
            //右下圆
            if (yuan1.Visible == false)
            {
                yuan1.SetDesktopLocation(Location.X + 150, Location.Y + 100);
                yuan1.Visible = true;
            }
            else
            {
            ...
            //右上圆
            if (yuan2.Visible == false)
            {
                yuan2.SetDesktopLocation(Location.X + 150, Location.Y - 75);
                yuan2.Visible = true;
            }
            else
            {
            ...
            //左下圆
            if (yuan3.Visible == false)
            {
                yuan3.SetDesktopLocation(Location.X - 100, Location.Y + 100);
                yuan3.Visible = true;
            }
            else
            {
            ...
            //左上圆
            if (yuan4.Visible == false)
            {
                yuan4.SetDesktopLocation(Location.X - 100, Location.Y - 75);
                yuan4.Visible = true;
            }
            else
            {
